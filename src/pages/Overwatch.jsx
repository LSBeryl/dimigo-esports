      ...
      <Col gap="1rem">
        <RuleBox>
          ...
          <Rule gap="2rem" align="flex-start">
            <div>
              <div>가. 기본 규칙</div> <div>① 예선전은 단판제 (쟁탈)</div>
              <div>② 4강은 3판 2선승제 (쟁탈, 밀기, 플래시포인트)</div>
              <div>③ 결승전은 3판 2선승제 (쟁탈, 점령, 호위)</div>
              <div>
                ④ 팀원이 6명이라면 본선에서 각 팀원이 무조건 한 판 이상은 뛰어야
                함
              </div>
            ...
            <div>
              <div>라. 레벨별 점수 분류</div> <div>① 티어 없을 시 적용</div>
              <div>② 티어 있으면 둘 중 더 높은 점수 적용</div>
